  ...
  function (
    ...
    return declare([BaseWidgetSetting, _TemplatedMixin], {
      ...
      _validateTable: function () {
        ...
        // Guillaume
        // check if only one field not editable (in this case only the geometry will be editable)
        if (rows.length === 1 && this._fieldsTable.getRowData(rows[0]).isEditable == false) {
            return true;
        }
