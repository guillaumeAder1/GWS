...
define([
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
        ...
        onReceiveData: function(name, widgetId, data, historyData) {
            ...
            this._schemeID = data.schemeID;
            this._initToCreateAOIBuffer([data.graphic]);
            ...
            this._onReportTabClick().then(lang.hitch(this, function(res) {
                console.log(res);
                var data;
                if (this.reportDijit) {
            ...
            //         this._showMessage(this.nls.reportsTab.errorInPrintingReport);
            //     }
            //     // on.emit(this.printActionButton, 'click', {
            //     //     bubbles: true,
            //     //     cancelable: true
            //     // });
            // }), 3000)
        ...
        /**
         * Guillaume
         * this function need to returna promise to have controll
         */
        ...
        _onReportTabClick: function() {
             ...
             * 
             * Guillaume 
             * this._aoiGraphicsLayer.graphics is the Geometry used for the query
             * need to override to use our own Geometry
             */
            var d = new Deferred();
            ...
            if (!this._isReportGenerated) {
                 ...
                 */
                this._initializeImpactSummaryReportWidget().then(lang.hitch(this, function(res) {
                    d.resolve("Total process ok");
                }));
            }
        ...
        _initToCreateAOIBuffer: function(graphics) {
            ...
            if (this._drawTool && !(this._drawTool.selectTool.isActive())) {
                /**
                 * Guillaume 
                 * causing attribute inspector to disapears
                 */
                this._drawTool.clearAllSelections();
            }
            // Reset start point
        ...
        /**
         * Guillaume 
         * where the geometry is draw and buffer added
         */
        ...
        /**
         * Guillaume
         * this is where we activate the Report button 
         * does some check on the AIO area before enabeling btn
         */
        ...
        /**
         * Guillaume
         * this function need to return a promise to have controller over
         */
        /**
            ...
            for (i = 0; i < this.config.layers.length; i++) {
                ...
                if (featureLayerObj) {
                    impactSummaryReportObj = new ImpactSummaryReport({
                        ...
                        maxFeaturesForAnalysis: this.config.maxFeaturesForAnalysis,
                        schemeID: Number(this._schemeID)
